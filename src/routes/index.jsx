  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        full stack web developer with a passion for creating functional, smart,
        and responsive websites. I am a graduate of the{" "}
        <span className="emp1">
          University of Wisconsins Full Stack Web Development Bootcamp
        </span>
        . I am skilled in HTML, CSS, JavaScript, Node.js, Express.js, MySQL,
        MongoDB, and React.js. I am a <span className="emp1">hard worker</span>,
        a <span className="emp1">quick learner</span>, and I am always looking
        for new <span className="emp1">challenges</span>. I am currently seeking
        a <span className="emp1">full-time position</span> as a web developer.
        Please feel free to look around my{" "}
